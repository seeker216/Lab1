...
public class testShortestPath_black {
	...
	public void testSP1() {
		...
		String result1 = fx.calcShortestPath("my", "will");
	...
	@Test
	public void testSP2() {
		String result2 = fx.calcShortestPath("will", "");
	...
	@Test
	public void testSP3() {
		String result3 = fx.calcShortestPath("", "");
		String expect3 = new String("The word is not exist!");
		assertEquals(expect3, result3);
	}
	@Test
	public void testSP4() {
		String result4 = fx.calcShortestPath("jk", "s");
