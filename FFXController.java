...
public class FFXController {
	...
	void openText(Stage stage) {
		stage.setTitle("Ñ¡ÔñÎÄ¼þ");

		final FileChooser fileChooser = new FileChooser();

		Button openButton = new Button("´ò¿ªÎÄ¼þ");
		...
		openButton.setOnAction((final ActionEvent e) -> {
			...
			if (file != null) {
				openLabel.setText("ÎÄ¼þ´ò¿ª³É¹¦");// if the file has been opened successfully,the other buttons will be
											// visible
				...
				openLabel.setText("ÎÄ¼þ´ò¿ªÊ§°Ü");// when failed to open the text,the other buttons won't be visible
	...
	protected void storePath(ActionEvent event) throws IOException {
		...
		Label label = new Label("ÎÄ¼þ±£´æ³É¹¦£¬Â·¾¶Îª:" + fileName);
		Pane pane = new Pane();
